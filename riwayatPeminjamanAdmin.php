...
// include 'koneksi.php'; // Will be included within the main content area
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Riwayat Peminjaman Ruangan - Admin - Sistem Pengelolaan Laboratorium</title>
  ...
  <style>
    ...
    .sidebar {
      ...
      height: 82vh;
      border-radius: 12px;
      width: 278px; /* Explicit width for desktop sidebar */
    }
    ...
    @media (max-width: 991.98px) {
      .sidebar {
        border-radius: 0;
        height: 100vh;
        width: 100%; /* Full width for offcanvas */
      }
    }
    ...
    <div class="row flex-grow-1 g-0">
      ...
      <main class="col bg-white px-3 px-md-4 py-3 position-relative">
        <div class="mb-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="#">Riwayat Peminjaman</a></li>
        ...
        if (isset($_SESSION['notification'])) {
            ...
            echo "<div class='alert alert-" . htmlspecialchars($notification['type']) . " alert-dismissible fade show' role='alert'>"; // Removed m-3, will rely on main padding
        ...
        <div class="table-responsive">
          <table class="table table-hover align-middle table-bordered">
            ...
            <tbody>
              ...
              } // End of formatIndonesianDate function and its conditional block
              ...
              if ($stmt === false) {
                echo "<tr><td colspan='6' class='text-center text-danger'>Error fetching data: " . htmlspecialchars(print_r(sqlsrv_errors(), true)) . "</td></tr>";
              } else {
                if (sqlsrv_has_rows($stmt)) {
                  while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                    ...
                    $iconTitle = 'Status: ' . htmlspecialchars($statusText); 
                    ...
                    if (stripos($statusText, 'Menunggu Approval') !== false) {
                        ...
                        $iconTitle = 'Ditolak';
                    } elseif (stripos($statusText, 'Disetujui') !== false) { 
                        $iconClass = 'bi-check-lg text-primary';
                        $iconTitle = 'Disetujui';
                    ...
                    echo "<a href='detailRiwayatRuanganAdmin.php?id=" . urlencode($row['idPeminjamanRuangan']) . "' class='text-info' title='Detail Peminjaman' style='text-decoration: none;'><i class='bi bi-list-ul' style='font-size: 1.3rem;'></i></a>"; 
                    echo "</td>"; 
                    echo "</tr>";
                  }
                } else {
                  echo "<tr><td colspan='6' class='text-center'>No room loan history found.</td></tr>";
                }
