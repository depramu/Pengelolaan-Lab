...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($role === 'Peminjam') {
        ...
        if ($row_mhs) {
            ...
            if ($row_kry) {
                if ($row_kry['jenisRole'] === null || $row_kry['jenisRole'] === '' || $row_kry['jenisRole'] === 'Peminjam') {
                ...
                $identifier_error = '*NIM / NPK tidak ditemukan';
            }
        }
        ...
        if ($row) {
            if ($kataSandi === $row['kataSandi']) {
                if (isset($row['jenisRole']) && $row['jenisRole'] === $expectedRole) {
            ...
            $identifier_error = '*NPK tidak ditemukan';
        }
    }
}
?>
    ...
    <div class="container-login">
        <div class="login-left">
            <div class="w-100 mb-4">
                <img src="../icon/logo-astratech.png" alt="Logo Astra" style="width:60px; margin-bottom:12px;">
            </div>
                ...
                <form action="login.php?role=<?php echo htmlspecialchars($role); ?>" method="POST">
                    <div class="mb-3">
                        <label for="identifier" class="form-label d-flex align-items-start">
                            ...
                            <span class="text-danger" style="padding-left: 10px;"><?php echo htmlspecialchars($identifier_error); ?></span>
                        </label>
                    ...
                    <div class="mb-2">
                        <label for="kataSandi" class="form-label d-flex align-items-start">
                            ...
                            <span class="text-danger" style="padding-left: 10px;"><?php echo htmlspecialchars($password_error); ?></span>
                        </label>
                        <div class="input-group">
