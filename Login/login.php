...
$error_message = '';
$role = $_GET['jenisRole'] ?? 'Peminjam'; // Ambil role dari URL, defaultnya 'Peminjam'
        ...
        switch ($role) {
            case 'Peminjam':
                ...
                if ($row_kry && $kataSandi === $row_kry['kataSandi']) {
                    ...
                    header(header: 'Location: ../Menu Peminjam/dashboardPeminjam.php');
                    exit;
                }
            ...
            case 'Ka UPT':
                ...
                if ($row && $kataSandi === $row['kataSandi']) {
