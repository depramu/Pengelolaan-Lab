    ...
    <div class="role-container ">
        <div class="role-card">
            ...
            <div class="role-right">
                <h3>Login Sebagai</h3>
                <a href="loginPeminjam.php" class="btn btn-light role-btn fw-bold" style="color: #065ba6;">Peminjam</a>
                <a href="loginPIC.php" class="btn btn-light role-btn fw-bold" style="color: #065ba6;">PIC Aset</a>
                <a href="loginKaUPT.php" class="btn btn-light role-btn fw-bold" style="color: #065ba6;">Ka UPT</a>
            </div>
        </div>
    </div>
</body>
