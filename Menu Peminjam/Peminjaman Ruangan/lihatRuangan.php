        ...
        <div class="row flex-grow-1 g-0">
            ...
            <nav class="col-auto sidebar d-none d-lg-flex flex-column p-3  ms-lg-4">
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="nav-item mb-2">
                        <?php
                        // Perbaiki deteksi current page untuk submenu Peminjaman
                        $isPeminjamanActive = (
                        ...
                        <div class="collapse ps-4<?php echo $isPeminjamanActive ? ' show' : ''; ?>" id="peminjamanSubmenu">
                            ...
                            <a href="cekRuangan.php" class="nav-link<?php echo ($currentPage == 'cekRuangan.php' || $currentPage == 'lihatRuangan.php') ? ' active-submenu' : ''; ?>">Ruangan</a>
                        </div>
                    </li>
                    <li class="nav-item mb-2">
                        <?php
                        // Perbaiki deteksi current page untuk submenu Riwayat
                        $isRiwayatActive = (
                            $currentPage == 'riwayatBarang.php' ||
                            $currentPage == 'riwayatRuangan.php'
                        );
                        ?>
                        ...
                        <div class="collapse ps-4<?php echo $isRiwayatActive ? ' show' : ''; ?>" id="riwayatSubmenu">
                            ...
                            <a href="../Riwayat Ruangan/riwayatRuangan.php" class="nav-link<?php echo ($currentPage == 'riwayatRuangan.php') ? ' active' : ''; ?>">Ruangan</a>
                        </div>
                    </li>
                        ...
                        <ul class="nav nav-pills flex-column mb-auto">
                            ...
                            <li class="nav-item mb-2">
                                ...
                                <div class="collapse ps-4<?php echo $isRiwayatActiveMobile ? ' show' : ''; ?>" id="riwayatSubmenuMobile">
                                    <a href="#" class="nav-link<?php echo ($currentPage == 'riwayatBarang.php') ? ' active-submenu' : ''; ?>">Barang</a>
                                    <a href="cekRuangan.php" class="nav-link<?php echo ($currentPage == 'riwayatRuangan.php') ? ' active-submenu' : ''; ?>">Ruangan</a>
                                </div>
                            </li>
                            <li class="nav-item mt-0">
                                <a href="#" class="nav-link logout" data-bs-toggle="modal" data-bs-target="#logoutModal"><img src="../../icon/exit.png">Log Out</a>
