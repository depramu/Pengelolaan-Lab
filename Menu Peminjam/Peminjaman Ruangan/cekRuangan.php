    ...
    <div class="container-fluid min-vh-100 d-flex flex-column p-0">
        ...
        <div class="row flex-grow-1 g-0">
            ...
            <nav class="col-auto sidebar d-none d-lg-flex flex-column p-3  ms-lg-4">
                <ul class="nav nav-pills flex-column mb-auto">
                    <li class="nav-item mb-2">
                        <a href="../dashboardPeminjam.php" class="nav-link <?php echo ($currentPage == 'dashboardPeminjam.php') ? 'active' : ''; ?>"><img src="../../icon/dashboard0.svg">Dashboard</a>
                    </li>
                    <li class="nav-item mb-2">
                        <?php
                        $isPeminjamanActive = ($currentPage == 'peminjamanBarang.php' || $currentPage == 'cekRuangan.php');
                        ?>
                        <a class="nav-link d-flex justify-content-between align-items-center <?php echo $isPeminjamanActive ? 'active' : ''; ?>" data-bs-toggle="collapse" href="#peminjamanSubmenu" role="button" aria-expanded="<?php echo $isPeminjamanActive ? 'true' : 'false'; ?>" aria-controls="peminjamanSubmenu">
                            <span><img src="../../icon/peminjaman.svg">Peminjaman</span>
                            <i class="bi bi-chevron-down transition-chevron ps-3"></i>
                        </a>
                        <div class="collapse ps-4<?php echo $isPeminjamanActive ? ' show' : ''; ?>" id="peminjamanSubmenu">
                            <a href="../Peminjaman Barang/cekBarang.php" class="nav-link <?php echo ($currentPage == 'peminjamanBarang.php') ? 'active-submenu' : ''; ?>">Barang</a>
                            <a href="cekRuangan.php" class="nav-link <?php echo ($currentPage == 'cekRuangan.php') ? 'active-submenu' : ''; ?>">Ruangan</a>
                        </div>
                    </li>
                    <li class="nav-item mb-2">
                        <?php
                        // Determine if one of the Riwayat submenu is active
                        $isRiwayatActive = ($currentPage == 'riwayatBarang.php' || $currentPage == 'riwayatRuangan.php');
                        ?>
                        <a class="nav-link d-flex justify-content-between align-items-center <?php echo $isRiwayatActive ? 'active' : ''; ?>" data-bs-toggle="collapse" href="#riwayatSubmenu" role="button" aria-expanded="<?php echo $isRiwayatActive ? 'true' : 'false'; ?>" aria-controls="riwayatSubmenu">
                            <span><img src="../../icon/riwayat.svg" style="width: 28px; height: 28px; object-fit: contain;">Riwayat</span>
                            <i class="bi bi-chevron-down transition-chevron ps-3"></i>
                        </a>
                        <div class="collapse ps-4<?php echo $isRiwayatActive ? ' show' : ''; ?>" id="riwayatSubmenu">
                            <a href="../Riwayat Barang/riwayatBarang.php" class="nav-link <?php echo ($currentPage == 'riwayatBarang.php') ? 'active-submenu' : ''; ?>">Barang</a>
                            <a href="../Riwayat Ruangan/riwayatRuangan.php" class="nav-link <?php echo ($currentPage == 'riwayatRuangan.php') ? 'active-submenu' : ''; ?>">Ruangan</a>
                        </div>
                    </li>
                ...
                <div class="offcanvas-body p-0">
                    <nav class="sidebar flex-column p-4 h-100">
                        <ul class="nav nav-pills flex-column mb-auto">
                            ...
                            <li class="nav-item mb-2">
                                <?php
                                $isPeminjamanActiveMobile = ($currentPage == 'peminjamanBarang.php' || $currentPage == 'cekRuangan.php');
                                ?>
                                <a class="nav-link d-flex justify-content-between align-items-center <?php echo $isPeminjamanActiveMobile ? 'active' : ''; ?>" data-bs-toggle="collapse" href="#peminjamanSubmenuMobile" role="button" aria-expanded="<?php echo $isPeminjamanActiveMobile ? 'true' : 'false'; ?>" aria-controls="peminjamanSubmenuMobile">
                                    <span><img src="../../icon/peminjaman.svg">Peminjaman</span>
                                    <i class="bi bi-chevron-down transition-chevron ps-3"></i>
                                </a>
                                <div class="collapse ps-4<?php echo $isPeminjamanActiveMobile ? ' show' : ''; ?>" id="peminjamanSubmenuMobile">
                                    <a href="peminjamanBarang.php" class="nav-link <?php echo ($currentPage == 'peminjamanBarang.php') ? 'active-submenu' : ''; ?>">Barang</a>
                                    <a href="cekRuangan.php" class="nav-link <?php echo ($currentPage == 'cekRuangan.php') ? 'active-submenu' : ''; ?>">Ruangan</a>
                                </div>
                            </li>
                            <li class="nav-item mb-2">
                                <?php
                                $isRiwayatActiveMobile = ($currentPage == 'riwayatBarang.php' || $currentPage == 'riwayatRuangan.php');
                                ?>
                                <a class="nav-link d-flex justify-content-between align-items-center <?php echo $isRiwayatActiveMobile ? 'active' : ''; ?>" data-bs-toggle="collapse" href="#riwayatSubmenuMobile" role="button" aria-expanded="<?php echo $isRiwayatActiveMobile ? 'true' : 'false'; ?>" aria-controls="riwayatSubmenuMobile">
                                    <span><img src="../../icon/riwayat.svg">Riwayat</span>
                                    <i class="bi bi-chevron-down transition-chevron ps-3"></i>
                                </a>
                                <div class="collapse ps-4<?php echo $isRiwayatActiveMobile ? ' show' : ''; ?>" id="riwayatSubmenuMobile">
                                    <a href="riwayatBarang.php" class="nav-link <?php echo ($currentPage == 'riwayatBarang.php') ? 'active-submenu' : ''; ?>">Barang</a>
                                    <a href="riwayatRuangan.php" class="nav-link <?php echo ($currentPage == 'riwayatRuangan.php') ? 'active-submenu' : ''; ?>">Ruangan</a>
                                </div>
                            </li>
                            <li class="nav-item mt-0">
                                <a href="#" class="nav-link logout" data-bs-toggle="modal" data-bs-target="#logoutModal"><img src="../../icon/exit.png">Log Out</a>
            ...
            <main class="col bg-white px-3 px-md-4 py-3 position-relative">
                ...
                <!-- pilih tanggal peminjaman dan waktu peminjaman -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="../../index.php"><button type="button" class="btn btn-primary ps-4 pe-4">Ya</button></a>
                </div>
            </div>
        </div>
    </div>
