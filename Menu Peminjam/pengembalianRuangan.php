                    ...
                    <div class="col-md-8 col-lg-12 " style="margin-right: 5px;">
                        <div class="card border border-dark">
                            ...
                            <div class="card-body p-4 scrollable-card-content">
                                ...
                                <?php elseif ($data): ?>
                                    <form id="formPengembalian" action="prosesPengembalian.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="d-flex justify-content-between mt-4 pt-3">
                                            <a href="dataPeminjaman.php" class="btn btn-secondary px-4">Kembali</a>
