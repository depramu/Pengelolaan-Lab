...
<head>
    ...
    <title>Riwayat Peminjaman Barang - Sistem Pengelolaan Laboratorium</title>
            ...
            <nav class="col-auto sidebar d-none d-lg-flex flex-column p-3  ms-lg-4">
                <ul class="nav nav-pills flex-column mb-auto">
                    <li class="nav-item mb-2">
                        <a href="dashboardPeminjam.php" class="nav-link <?php if ($currentPage === 'dashboardPeminjam.php') echo 'active-submenu'; ?>"><img src="../icon/dashboard0.svg">Dashboard</a>
                    </li>
                    <li class="nav-item mb-2">
                    ...
                    <li class="nav-item mb-2">
                        ...
                        <div class="collapse ps-4 <?php if ($currentPage === 'DetailPeminjamanBrg.php') echo 'show'; ?>" id="riwayatSubmenu">
                            <a href="DetailPeminjamanBrg.php" class="nav-link <?php if ($currentPage === 'DetailPeminjamanBrg.php') echo 'active-submenu'; ?>">Barang</a>
                            <a href="DetailPeminjamanRuangan.php" class="nav-link <?php if ($currentPage === 'DetailPeminjamanRuangan.php') echo 'active-submenu'; ?>">Ruangan</a>
                        </div>
                    </li>
                    ...
                    <nav class="sidebar flex-column p-4 h-100">
                        <ul class="nav nav-pills flex-column mb-auto">
                            ...
                            <li class="nav-item mb-2">
                                ...
                                <div class="collapse ps-4 <?php if ($currentPage === 'riwayatBarang.php') echo 'show'; ?>" id="riwayatSubmenuMobile">
                                    <a href="DetailPeminjamanBrg.php" class="nav-link <?php if ($currentPage === 'DetailPeminjamanBrg.php') echo 'active-submenu'; ?>">Barang</a>
                                    <a href="DetailPeminjamanRuangan.php" class="nav-link <?php if ($currentPage === 'DetailPeminjamanRuangan.php') echo 'active-submenu'; ?>">Ruangan</a>
                                </div>
                            </li>
                                ...
                                <div class="card-body">
                                    <form method="POST">
                                        ...
                                        <div class="d-flex justify-content-start mt-4">
                                            <a href="riwayatBarang.php" class="btn btn-secondary">Kembali</a>
                                        </div>
