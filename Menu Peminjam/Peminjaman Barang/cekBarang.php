...
// Fix current page detection to work with possible path
        ...
        <div class="row flex-grow-1 g-0">
            ...
            <nav class="col-auto sidebar d-none d-lg-flex flex-column p-3  ms-lg-4">
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="nav-item mb-2">
                        <?php
                        $isPeminjamanActive = ($currentPage == 'peminjamanBarang.php' || $currentPage == 'cekBarang.php');
                        ?>
                        ...
                        <div class="collapse ps-4<?php echo $isPeminjamanActive ? ' show' : ''; ?>" id="peminjamanSubmenu">
                            <a href="cekBarang.php" class="nav-link<?php echo ($currentPage === 'cekBarang.php') ? ' active-submenu' : ''; ?>">Barang</a>
                            <a href="../Peminjaman Ruangan/cekRuangan.php" class="nav-link<?php echo ($currentPage === 'cekRuangan.php') ? ' active-submenu' : ''; ?>">Ruangan</a>
                        </div>
                    </li>
                    <li class="nav-item mb-2">
                ...
                <div class="offcanvas-body p-0">
                    <nav class="sidebar flex-column p-4 h-100">
                        <ul class="nav nav-pills flex-column mb-auto">
                            ...
                            <li class="nav-item mb-2">
                                <a class="nav-link d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#peminjamanSubmenuMobile" role="button" aria-expanded="<?php echo $isPeminjamanActive ? 'true' : 'false'; ?>" aria-controls="peminjamanSubmenuMobile">
                                    <span><img src="../../icon/peminjaman.svg">Peminjaman</span>
                                    <i class="bi bi-chevron-down transition-chevron ps-3"></i>
                                </a>
                                <div class="collapse ps-4<?php echo $isPeminjamanActive ? ' show' : ''; ?>" id="peminjamanSubmenuMobile">
                                    <a href="cekBarang.php" class="nav-link<?php echo ($currentPage === 'cekBarang.php') ? ' active-submenu' : ''; ?>">Barang</a>
