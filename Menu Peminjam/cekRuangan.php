...
if (isset($_POST['submit'])) {
    $tglPeminjamanRuangan = $_POST['tglPeminjamanRuangan'];
    $waktuMulai = $_POST['waktuMulai'];
    $waktuSelesai = $_POST['waktuSelesai'];

    // Store in session
    $_SESSION['tglPeminjamanRuangan'] = $tglPeminjamanRuangan;
...
// Get tanggal dan waktu from session if set, or from POST data
$tglPeminjamanRuangan = $_SESSION['tglPeminjamanRuangan'] ?? $_POST['tglPeminjamanRuangan'] ?? '';
$waktuMulai = $_SESSION['waktuMulai'] ?? $_POST['waktuMulai'] ?? '';
$waktuSelesai = $_SESSION['waktuSelesai'] ?? $_POST['waktuSelesai'] ?? '';

$query = "SELECT idRuangan, namaRuangan, kondisiRuangan, ketersediaan FROM Ruangan WHERE ketersediaan = 'Tersedia'";
if ($tglPeminjamanRuangan && $waktuMulai && $waktuSelesai) {
    $query .= " AND tglPeminjamanRuangan = ? AND waktuMulai = ? AND waktuSelesai = ?";
    $params = array($tglPeminjamanRuangan, $waktuMulai, $waktuSelesai);
