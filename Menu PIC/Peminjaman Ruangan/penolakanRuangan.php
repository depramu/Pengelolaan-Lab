                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <a href="peminjamanRuangan.php"><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tolak"></button></a>
                        </div>
                        <div class="modal-body">
                            <p>PIC Menolak Peminjaman Ruangan <?= htmlspecialchars($idPeminjamanRuangan) ?>.</p>
                        </div>
