    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($jumlahPengembalian <= 0 || $jumlahPengembalian > $jumlahBrg || empty($kondisiBrg) || $kondisiBrg == 'Pilih Kondisi Barang') {
            ...
            // LANGKAH 2: Update jumlah sisa & status di tabel Peminjaman_Barang
            ...
            // $stmt_update_peminjaman = sql    srv_query($conn, $query_update_peminjaman, $params_update_peminjaman);

            // LANGKAH 3: Update stok di tabel master Barang
            ...
            if ($stmt_insert_pengembalian && $stmt_update_stok) {
