...
<head>
    ...
    <title>Penolakan Barang - Sistem Pengelolaan Laboratorium</title>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <a href="peminjamanBarang.php"><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tolak"></button></a>
                        </div>
                        <div class="modal-body">
                            <p>PIC Menolak Peminjaman Barang <?= htmlspecialchars($idPeminjamanBrg) ?>.</p>
                        </div>
