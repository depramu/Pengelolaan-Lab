...
<head>
    ...
    <title>Detail Penolakan Barang - Sistem Pengelolaan Laboratorium</title>
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="nav-item mb-2">
                        ...
                        <div class="collapse ps-4 <?php if ($isPeminjamanActive) echo 'show'; ?>" id="pinjamSubmenu">
                            ...
                            <a href="peminjamanRuangan.php" class="nav-link <?php if ($currentPage === 'peminjamanRuangan.php' || $currentPage === 'detailPenolakanRuangan.php') echo 'active-submenu'; ?>">Ruangan</a>
                        </div>
                    </li>
                    <li class="nav-item mb-2">
                        <a href="#" class="nav-link"><img src="../../icon/graph-report0.png" class="sidebar-ic on-report">Laporan</a>
                    </li>
                ...
                <div class="offcanvas-body p-0">
                    <nav class="sidebar flex-column p-4 h-100">
                        <ul class="nav nav-pills flex-column mb-auto">
                            ...
                            <li class="nav-item mb-2">
                                pengajuanBarang.php<a href="#" class="nav-link"><img src="../../icon/graph-report0.png" class="sidebar-icon-report">Laporan</a>
                            </li>
                            <li class="nav-item mt-0">
                                <a href="../../index.php" class="nav-link logout" data-bs-toggle="modal" data-bs-target="#logoutModal"><img src="../../icon/exit.png">Log Out</a>
                            </li>
