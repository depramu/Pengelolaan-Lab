<?php
include 'koneksi.php';
$query = "SELECT idPeminjamanRuangan, idRuangan, tglPeminjamanRuangan, waktuMulaiPinjam, waktuSelesaiPinjam FROM Peminjaman_Ruangan";
        ...
        <div class="table-responsive">
          <table class="table table-hover align-middle table-bordered">
            ...
            <tbody>
              ...
              // Make sure $result is valid before trying to fetch rows
              if ($result !== false) {
                while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
              ?>
                <tr>
                  <td><?= $row['idPeminjamanRuangan'] ?></td>
                  <td><?= $row['idRuangan'] ?></td>
                  <td><?= $row['tglPeminjamanRuangan'] instanceof DateTime ? $row['tglPeminjamanRuangan']->format('Y-m-d') : $row['tglPeminjamanRuangan'] ?></td>
                  <td><?= isset($row['waktuMulaiPinjam']) ? ($row['waktuMulaiPinjam'] instanceof DateTime ? $row['waktuMulaiPinjam']->format('H:i') : $row['waktuMulaiPinjam']) : '' ?></td>
                  <td><?= isset($row['waktuSelesaiPinjam']) ? ($row['waktuSelesaiPinjam'] instanceof DateTime ? $row['waktuSelesaiPinjam']->format('H:i') : $row['waktuSelesaiPinjam']) : '' ?></td>
                  <td>
                    <?php
                    // --- ACTION COLUMN - STATUS ICON PLACEHOLDER LOGIC ---
                    $peminjamanId = $row['idPeminjamanRuangan'] ?? ''; // Get ID for demo
                    ...
                    <a href="detail_peminjaman.php?id=<?= htmlspecialchars($row['idPeminjamanRuangan']); ?>" class="text-secondary" title="Lihat Detail" style="vertical-align: middle;">
