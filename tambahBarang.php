...
// Dummy lokasi barang (seharusnya dari database)
$lokasiList = [
    'Rak 1',
    'Rak 2',
    'Lemari A',
...
$manajemenAsetPages = ['manajemenBarang.php', 'manajemenRuangan.php', 'tambahBarang.php'];
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="nav-item mb-2">
                        ...
                        <div class="collapse ps-4 <?php if ($isManajemenAsetActive) echo 'show'; ?>" id="manajemenAsetSubmenu">
                            <a href="manajemenBarang.php" class="nav-link <?php if ($currentPage === 'manajemenBarang.php' || $currentPage === 'tambahBarang.php') echo 'active-submenu'; ?>">Barang</a>
                                ...
                                <div class="card-body">
                                    <form method="POST">
                                        ...
                                        <div class="d-flex justify-content-between mt-4">
                                            <a href="manajemenBarang.php" class="btn btn-secondary">Kembali</a>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>Data barang berhasil disimpan.</p>
                                </div>
